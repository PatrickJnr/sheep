...
window backend. It passes all 63 conformance programs, byte for byte.
...
| [`../tests/conformance/suite.json`](../tests/conformance/suite.json) | 63 programs with their exact stdout, and 27 programs with the diagnostic codes they must produce |
| [`../tests/conformance/diagnostics.json`](../tests/conformance/diagnostics.json) | All 48 diagnostics, with both wordings and their placeholders, no need to retype them |
