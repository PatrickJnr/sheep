...
| [`../tests/conformance/diagnostics.json`](../tests/conformance/diagnostics.json) | All 46 diagnostics, with both wordings and their placeholders, no need to retype them |
