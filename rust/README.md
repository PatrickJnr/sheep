...
| [`../tests/conformance/suite.json`](../tests/conformance/suite.json) | 42 programs with their exact stdout, and 27 programs with the diagnostic codes they must produce |
| [`../tests/conformance/diagnostics.json`](../tests/conformance/diagnostics.json) | All 41 diagnostics, with both wordings and their placeholders, no need to retype them |
...
6. **`baa-stdlib`.** Seven modules, documented in
