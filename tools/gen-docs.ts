...
/**
 * Prose that belongs with a module and cannot be a one-line description.
 *
 * A table of signatures says what exists; it cannot say what a glob pattern
 * means or which offsets are legal, and those are exactly the questions a
 * reader has at the point of use. It lives here rather than in a hand-written
 * page so that it is published beside the functions it explains and cannot be
 * left behind when they change.
 */
